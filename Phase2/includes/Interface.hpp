...
class Interface
{
	...
	public :
		...
		std::stringstream doDefaultPriceFilterCommand(std::stringstream& input);
		std::stringstream doSortCommand(std::stringstream& input);
		...
		std::stringstream doSetManualWeightsCommand(std::stringstream& input);
		std::stringstream doGetManualWeightsCommand();
		std::stringstream doGetEstimatedWeightsCommand();
};
