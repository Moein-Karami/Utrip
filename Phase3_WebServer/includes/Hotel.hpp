...
class Hotel
{
	...
	public :
		...
		void deleteRooms();
		~Hotel();
		std::vector<std::string> generalPrint();
		...
		std::string getName();
		double getStdRoomCost();
		double getDeluxRoomCost();
		double getLuxRoomCost();
		double getPrmRoomCost();
		double getOverAllRating();
		std::vector<double> getRatingValues();
};
